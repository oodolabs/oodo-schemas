...
var log = require('logs').get('SchemaValidator');
 ...
 *
 * @param value {*|null} The payload of the event. Can be null if there is no payload
...
Schemas.prototype.getEventTimeSeriesData = function (value, eventSchemaUri) {
  ...
  return timeseriesData.filter(function (v) {
    return !!v;
  });
};
...
/*
 ...
 }, 'http://schema.dolink.co/protocol/game-controller.joystick#/events/state'));

 console.log(module.exports.getEventTimeSeriesData(null,
 'http://schema.dolink.co/protocol/game-controller.joystick#/events/shook'));


 console.log(module.exports.getServiceValidators('http://schema.dolink.co/protocol/game-controller.joystick'));*/
