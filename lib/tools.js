...
/*
 ...
 }, 'http://schema.oodo.co/protocol/game-controller.joystick#/events/state'));

 console.log(module.exports.getEventTimeSeriesData(null,
 'http://schema.oodo.co/protocol/game-controller.joystick#/events/shook'));


 console.log(module.exports.getServiceValidators('http://schema.oodo.co/protocol/game-controller.joystick'));*/
